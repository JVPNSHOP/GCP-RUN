...
URI="vless://${VLESS_UUID}@vpn.googleapis.com:443?path=%2F%40juevpn&security=tls&encryption=none&host=${CANONICAL_HOST}&type=ws&sni=${CANONICAL_HOST}#CHANNEL-JUE-VLESS-WS"
