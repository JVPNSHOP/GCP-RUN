...
# =================== JUE Custom UI (colors preserved as C_JUE_... internal names kept for compatibility) ===================
if [[ -t 1 && -z "${NO_COLOR:-}" ]]; then
  ...
  # Three-color palette for banner (you can change these three)
  B1=$'\e[38;5;46m'   # green
...
show_404_banner() {
  ...
  # Print the provided ASCII banner using a 3-color cycling scheme
  # Each line cycles through B1, B2, B3 for visual effect
  local lines=(
"___           ___     "
"    ___         /\  \         /\__\    "
"   /\__\        \:\  \       /:/ _/_   "
...
show_success() {
  printf "${C_JUE_GREEN}${BOLD}✓${RESET} ${C_JUE_GREEN}%s${RESET}\n" "$1"
}
show_info() {
  printf "${C_JUE_BLUE}${BOLD}ℹ${RESET} ${C_JUE_BLUE}%s${RESET}\n" "$1"
}
show_warning() {
  printf "${C_JUE_YELLOW}${BOLD}⚠${RESET} ${C_JUE_YELLOW}%s${RESET}\n" "$1"
}
show_error() {
  printf "${C_JUE_RED}${BOLD}✗${RESET} ${C_JUE_RED}%s${RESET}\n" "$1"
}
show_divider() {
  printf "${C_JUE_GRAY}%s${RESET}\n" "──────────────────────────────────────────────────────────"
}
show_kv() {
  printf "   ${C_JUE_GRAY}%s${RESET}  ${C_JUE_CYAN}%s${RESET}\n" "$1" "$2"
}
...
read -rp "${C_JUE_GREEN}👤 Enter Owner/Channel Chat ID(s):${RESET} " _ids || true
...
printf "\n${C_JUE_YELLOW}┌──────────────────────────────────────────────────────┐${RESET}\n"
printf "${C_JUE_YELLOW}│${RESET} ${C_JUE_CYAN}📡 Selected Protocol: VLESS WS${RESET}                         ${C_JUE_YELLOW}│${RESET}\n"
printf "${C_JUE_YELLOW}└──────────────────────────────────────────────────────┘${RESET}\n\n"
...
printf "\n${C_JUE_YELLOW}┌──────────────────────────────────────────────────────┐${RESET}\n"
printf "${C_JUE_YELLOW}│${RESET} ${C_JUE_CYAN}🌍 Select Deployment Region${RESET}                            ${C_JUE_YELLOW}│${RESET}\n"
printf "${C_JUE_YELLOW}└──────────────────────────────────────────────────────┘${RESET}\n\n"
...
printf "\n${C_JUE_YELLOW}┌──────────────────────────────────────────────────────┐${RESET}\n"
printf "${C_JUE_YELLOW}│${RESET} ${C_JUE_CYAN}⚙️ Compute Resources${RESET}                                  ${C_JUE_YELLOW}│${RESET}\n"
printf "${C_JUE_YELLOW}└──────────────────────────────────────────────────────┘${RESET}\n\n"
...
printf "\n${C_JUE_YELLOW}┌──────────────────────────────────────────────────────┐${RESET}\n"
printf "${C_JUE_YELLOW}│${RESET} ${C_JUE_CYAN}🪪 Service Details${RESET}                                    ${C_JUE_YELLOW}│${RESET}\n"
printf "${C_JUE_YELLOW}└──────────────────────────────────────────────────────┘${RESET}\n\n"
...
printf "\n${C_JUE_YELLOW}┌──────────────────────────────────────────────────────┐${RESET}\n"
printf "${C_JUE_YELLOW}│${RESET} ${C_JUE_CYAN}🕒 Deployment Time${RESET}                                    ${C_JUE_YELLOW}│${RESET}\n"
printf "${C_JUE_YELLOW}└──────────────────────────────────────────────────────┘${RESET}\n\n"
...
printf "\n${C_JUE_YELLOW}┌──────────────────────────────────────────────────────┐${RESET}\n"
printf "${C_JUE_YELLOW}│${RESET} ${C_JUE_CYAN}🔧 Enabling Required APIs${RESET}                             ${C_JUE_YELLOW}│${RESET}\n"
printf "${C_JUE_YELLOW}└──────────────────────────────────────────────────────┘${RESET}\n\n"
...
printf "\n${C_JUE_YELLOW}┌──────────────────────────────────────────────────────┐${RESET}\n"
printf "${C_JUE_YELLOW}│${RESET} ${C_JUE_CYAN}🚀 Deploying VLESS WS Service${RESET}                         ${C_JUE_YELLOW}│${RESET}\n"
printf "${C_JUE_YELLOW}└──────────────────────────────────────────────────────┘${RESET}\n\n"
...
show_kv "Image:" "${C_JUE_GRAY}docker.io/nkka404/vless-ws:latest${RESET}"
printf "\n"
...
printf "\n${C_JUE_YELLOW}┌──────────────────────────────────────────────────────┐${RESET}\n"
printf "${C_JUE_YELLOW}│${RESET} ${C_JUE_CYAN}✅ Deployment Successful${RESET}                               ${C_JUE_YELLOW}│${RESET}\n"
printf "${C_JUE_YELLOW}└──────────────────────────────────────────────────────┘${RESET}\n\n"
...
URI="vless://${VLESS_UUID}@vpn.googleapis.com:443?path=%2F%40nkka404&security=tls&encryption=none&host=${CANONICAL_HOST}&type=ws&sni=vpn.googleapis.com#CHANNEL-JUE-VLESS-WS"
