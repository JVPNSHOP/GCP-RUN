...
show_banner() {
  ...
  printf "${C_RED}${BOLD}"
  printf "╔══════════════════════════════════════════════════════════════════╗\n"
  printf "║ ${C_CYAN}  _   _  _____  _____     _____  _____  _____   _____  _____ ${C_RED}║\n"
  printf "║ ${C_CYAN} | | | ||  __ \\|  __ \\   / ____||  __ \\|  __ \\ / ____||  __ \\${C_RED}║\n"
  printf "║ ${C_CYAN} | | | || |__) | |__) | | (___  | |  | | |__) | (___  | |__) |${C_RED}║\n"
  printf "║ ${C_CYAN} | | | ||  ___/|  ___/   \\___ \\ | |  | |  _  / \\___ \\ |  _  /${C_RED}║\n"
  printf "║ ${C_CYAN} | |_| || |    | |       ____) || |__| | | \\ \\ ____) || | \\ \\${C_RED}║\n"
  printf "║ ${C_CYAN}  \\___/ |_|    |_|      |_____/ |_____/|_|  \\_\\_____/ |_|  \\_\\${C_RED}║\n"
  printf "║ ${C_RED}\n"
  printf "║ ${C_YELLOW}${BOLD}🚀 VLESS WS DEPLOYMENT SYSTEM => VERSION - 2.0 ${C_RED}\n"
  printf "║ ${C_GREEN}⚡ Powered by @Pussy1900 ${C_RED}\n"
  printf "║ ${C_RED}\n"
  printf "╚══════════════════════════════════════════════════════════════════╝${RESET}\n"
  printf "\n"

  # Replace 404 graphic with three-color announcement text
  printf "${C_CYAN}${BOLD}  ██████╗ ██████╗  ██████╗ ███████╗██████╗ ${RESET}\n"
  printf "${C_YELLOW}${BOLD}  ██╔══██╗██╔══██╗██╔═══██╗██╔════╝██╔══██╗${RESET}\n"
  printf "${C_GREEN}${BOLD}  ██████╔╝██████╔╝██║   ██║█████╗  ██████╔╝${RESET}\n"
  printf "\n"
  printf "${C_CYAN}${BOLD}                     GCP SCRIPT${RESET}\n"
  printf "${C_YELLOW}${BOLD}                     NOT FOR SALE${RESET}\n\n"

  # Script By line — prominent and colorful
  printf "${C_BLUE}${BOLD}============================================================${RESET}\n"
  printf " ${C_CYAN}${BOLD}SCRIPT BY :${RESET} ${C_YELLOW}${BOLD}JUE${RESET} ${C_GREEN}${BOLD}HTET${RESET}\n"
  printf "${C_BLUE}${BOLD}============================================================${RESET}\n\n"

  printf "${C_BLUE}${BOLD} @Pussy1900${RESET}\n\n"
}
...
DEFAULT_LABEL="Join @Pussy1900"
DEFAULT_URL="https://t.me/Pussy1990"
BTN_LABELS=(); BTN_URLS=()
...
printf "\n"
show_divider
printf "\n${C_RED}${BOLD}@Pussy1900${RESET} ${C_GRAY}|${RESET} ${C_CYAN}VLESS WebSocket Deployment System${RESET} ${C_GRAY}|${RESET} ${C_GREEN}v2.0${RESET}\n"
printf "${C_GRAY}──────────────────────────────────────────────────────────${RESET}\n\n"
