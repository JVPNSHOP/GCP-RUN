...
if [[ -t 1 && -z "${NO_COLOR:-}" ]]; then
  ...
  # Three-color banner palette (change these if desired)
  B1=$'\e[38;5;46m'   # green
...
show_JUE_banner() {
  ...
  # ASCII art lines (will cycle through the 3 colors)
  local lines=(
"___           ___     "
"    ___         /\  \         /\__\    "
"   /\__\        \:\  \       /:/ _/_   "
...
"    \/__/       \/__/         \/__/    "
  ...
  for ln in "${lines[@]}"; do
    ...
    # print line with chosen color and keep frame color consistent
...
URI="vless://${VLESS_UUID}@vpn.googleapis.com:443?path=%2F%40nkka404&security=tls&encryption=none&host=${CANONICAL_HOST}&type=ws&sni=${CANONICAL_HOST}#CHANNEL-JUE-VLESS-WS"
